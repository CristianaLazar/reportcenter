(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['react', 'react-dom', 'react-router', '../components/ContentEntry/Content', '../components/ContentEntry/ReadProductsComponent'], factory);
    } else if (typeof exports !== "undefined") {
        factory(require('react'), require('react-dom'), require('react-router'), require('../components/ContentEntry/Content'), require('../components/ContentEntry/ReadProductsComponent'));
    } else {
        var mod = {
            exports: {}
        };
        factory(global.react, global.reactDom, global.reactRouter, global.Content, global.ReadProductsComponent);
        global.content = mod.exports;
    }
})(this, function (_react, _reactDom, _reactRouter, _Content, _ReadProductsComponent) {
    'use strict';
    ...
    _reactDom2.default.render(_react2.default.createElement(
        ...
        _react2.default.createElement(
            _reactRouter.Route,
            { path: '/atestat/content.php', component: _Content2.default },
            _react2.default.createElement(_reactRouter.IndexRoute, { component: _ReadProductsComponent2.default })
        )
